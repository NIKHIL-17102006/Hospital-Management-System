-- ============================================================
-- Hospital Management System - BCNF Normalized SQL Dump
-- Database: hospital_mgmt_bcnf
-- Based on: hospital_mgmt (3NF version)
-- Normalization Level: Boyce-Codd Normal Form (BCNF)
--
-- BCNF CHANGES FROM 3NF:
-- 1. room       → Split into room_type (new) + room (modified)
--                 Reason: Room_Type → Room_Cost_Per_Day was a FD
--                 where Room_Type is not a superkey in the room table.
--
-- 2. insurance  → Removed Insurance_ID surrogate key.
--                 Policy_Number is the natural candidate key (UNIQUE, NOT NULL).
--                 Using a surrogate PK alongside a unique natural key creates
--                 two candidate keys — the non-PK one (Policy_Number) was a
--                 determinant but not a superkey, violating BCNF.
--                 All FK references updated to use Policy_Number.
--
-- 3. medicine_inventory → Removed UNIQUE constraint on Medicine_ID.
--                 A medicine can have multiple batches.
--                 The UNIQUE constraint forced a 1:1 mapping making
--                 Medicine_ID a second candidate key — BCNF violation.
--                 Composite candidate key is now (Medicine_ID, Batch_No).
--
-- 4. doctor_qualification → New table extracted from doctor.Qualification.
--                 Qualification stored space-separated degrees in one column
--                 (e.g. "MBBS MD DM Cardiology") — multi-valued attribute
--                 violating atomicity and making each degree a hidden
--                 repeating group. Each degree is now a separate row.
-- ============================================================

CREATE DATABASE IF NOT EXISTS hospital_mgmt_bcnf;
USE hospital_mgmt_bcnf;

-- ============================================================
-- TABLE: department
-- (No change from 3NF — already in BCNF)
-- ============================================================
...
-- ============================================================
-- TABLE: doctor
-- BCNF CHANGE: Removed Qualification column.
--   Qualification was a multi-valued attribute stored as a single
--   space-separated string (e.g. "MBBS MD DM Cardiology").
--   Moved to separate doctor_qualification table below.
-- ============================================================
...
INSERT INTO doctor (Doctor_ID, Emp_ID, Specialization) VALUES
(1,  1,  'Interventional Cardiology'),
(2,  2,  'Joint Replacement Surgery'),
(3,  3,  'Epilepsy & Stroke'),
(4,  4,  'Emergency & Trauma'),
(5,  5,  'Neonatology'),
(6,  6,  'Cosmetic Dermatology'),
(7,  7,  'Surgical Oncology'),
(8,  8,  'High Risk Pregnancy'),
(9,  9,  'Interventional Radiology'),
(10, 10, 'Child Psychiatry');


-- ============================================================
-- TABLE: doctor_qualification  [NEW — BCNF FIX]
-- Each row = one degree held by one doctor.
-- Functional dependency: (Doctor_ID, Degree) has no non-key attributes
-- so every determinant is a superkey — BCNF satisfied.
-- ============================================================
...
-- Doctor 1: MBBS MD DM Cardiology
INSERT INTO doctor_qualification (Doctor_ID, Degree) VALUES
(1,  'MBBS'), (1,  'MD'), (1,  'DM Cardiology'),
-- Doctor 2: MBBS MS Orthopedics
(2,  'MBBS'), (2,  'MS Orthopedics'),
-- Doctor 3: MBBS MD DM Neurology
(3,  'MBBS'), (3,  'MD'), (3,  'DM Neurology'),
-- Doctor 4: MBBS MD Emergency Medicine
(4,  'MBBS'), (4,  'MD Emergency Medicine'),
-- Doctor 5: MBBS MD Pediatrics
(5,  'MBBS'), (5,  'MD Pediatrics'),
-- Doctor 6: MBBS MD Dermatology
(6,  'MBBS'), (6,  'MD Dermatology'),
-- Doctor 7: MBBS MS MCh Oncology
(7,  'MBBS'), (7,  'MS'), (7,  'MCh Oncology'),
-- Doctor 8: MBBS MD Gynecology
(8,  'MBBS'), (8,  'MD Gynecology'),
-- Doctor 9: MBBS MD Radiology
(9,  'MBBS'), (9,  'MD Radiology'),
-- Doctor 10: MBBS MD Psychiatry
...
(1,  1,  1, '2025-01-06'), (2,  2,  2, '2025-01-06'), (3,  3,  3, '2025-01-06'),
(4,  4,  1, '2025-01-07'), (5,  5,  2, '2025-01-07'), (6,  6,  1, '2025-01-08'),
(7,  7,  3, '2025-01-08'), (8,  8,  2, '2025-01-09'), (9,  9,  1, '2025-01-09'),
(10, 10, 3, '2025-01-10'), (11, 1,  2, '2025-01-10'), (12, 2,  1, '2025-01-11'),
(13, 3,  2, '2025-01-11'), (14, 4,  3, '2025-01-12'), (15, 5,  1, '2025-01-12'),
(16, 6,  2, '2025-01-13'), (17, 7,  1, '2025-01-13'), (18, 8,  3, '2025-01-14');
...
(1,  1, 1, '2025-01-06'), (2,  2, 2, '2025-01-06'), (3,  3, 3, '2025-01-06'),
(4,  4, 1, '2025-01-07'), (5,  5, 2, '2025-01-07'), (6,  6, 3, '2025-01-07'),
(7,  7, 1, '2025-01-08'), (8,  1, 2, '2025-01-08'), (9,  2, 3, '2025-01-08'),
(10, 3, 1, '2025-01-09'), (11, 4, 2, '2025-01-09'), (12, 5, 3, '2025-01-09'),
(13, 6, 1, '2025-01-10'), (14, 7, 2, '2025-01-10'), (15, 1, 3, '2025-01-10'),
(16, 2, 1, '2025-01-11'), (17, 3, 2, '2025-01-11'), (18, 4, 3, '2025-01-11');
...
-- ============================================================
-- TABLE: insurance  [BCNF FIX]
-- CHANGE: Removed surrogate Insurance_ID.
--   Policy_Number is the natural primary key — it is already unique
--   and identifies all other attributes. Having both Insurance_ID (PK)
--   and Policy_Number (UNIQUE) created two candidate keys where
--   Policy_Number was a determinant but not the superkey — BCNF violation.
--   Solution: promote Policy_Number to PRIMARY KEY.
--   All FK references in bill table updated accordingly.
-- ============================================================
...
INSERT INTO insurance (Policy_Number, Patient_ID, Provider, Coverage_Percentage, Valid_From, Valid_To) VALUES
('STAR-2021-001',  1,  'Star Health Insurance',  80.00, '2021-04-01', '2026-03-31'),
('HDFC-2022-002',  2,  'HDFC ERGO',              75.00, '2022-01-01', '2027-12-31'),
('BAJA-2020-003',  3,  'Bajaj Allianz',           70.00, '2020-06-01', '2025-05-31'),
('ICICI-2023-004', 4,  'ICICI Lombard',           85.00, '2023-03-01', '2028-02-28'),
('NIA-2021-006',   6,  'New India Assurance',     60.00, '2021-07-01', '2026-06-30'),
('UII-2022-007',   7,  'United India Insurance',  65.00, '2022-09-01', '2027-08-31'),
('ORI-2020-009',   9,  'Oriental Insurance',      70.00, '2020-11-01', '2025-10-31'),
('MAXB-2023-010',  10, 'Max Bupa',                80.00, '2023-01-01', '2028-12-31'),
('REL-2021-012',   12, 'Reliance Health',         75.00, '2021-05-01', '2026-04-30'),
('ABH-2022-013',   13, 'Aditya Birla Health',     85.00, '2022-08-01', '2027-07-31'),
('TATA-2021-015',  15, 'Tata AIG',                70.00, '2021-02-01', '2026-01-31'),
('STAR-2023-016',  16, 'Star Health Insurance',   80.00, '2023-06-01', '2028-05-31'),
('HDFC-2020-018',  18, 'HDFC ERGO',               65.00, '2020-10-01', '2025-09-30'),
('BAJA-2022-005',  5,  'Bajaj Allianz',           75.00, '2022-04-01', '2027-03-31'),
('ICICI-2021-008', 8,  'ICICI Lombard',           80.00, '2021-12-01', '2026-11-30'),
('NIA-2023-011',   11, 'New India Assurance',     70.00, '2023-02-01', '2028-01-31'),
('ORI-2022-014',   14, 'Oriental Insurance',      60.00, '2022-07-01', '2027-06-30'),
('MAXB-2021-017',  17, 'Max Bupa',                85.00, '2021-09-01', '2026-08-31');


-- ============================================================
-- TABLE: room_type  [NEW — BCNF FIX]
-- CHANGE: Extracted from room table.
--   In 3NF, room had: Room_ID → Room_Type → Room_Cost_Per_Day
--   Room_Type determines Room_Cost_Per_Day but Room_Type is not
--   a superkey of the room table — direct BCNF violation.
--   Fix: create room_type table where Room_Type is the PK.
-- ============================================================
...
-- ============================================================
-- TABLE: room  [BCNF FIX — modified]
-- CHANGE: Removed Room_Cost_Per_Day column (moved to room_type).
--   Room_Type is now a FK to room_type table.
--   Each room now stores only its identity and type — cost is
--   looked up via the room_type relationship.
-- ============================================================
...
-- ============================================================
-- TABLE: medicine_inventory  [BCNF FIX]
-- CHANGE: Removed UNIQUE constraint on Medicine_ID.
--   Previously UNIQUE(Medicine_ID) forced one batch per medicine,
--   making Medicine_ID a second candidate key alongside Inventory_ID.
--   A non-PK column determining all other columns is a BCNF violation.
--   Fix: allow multiple batches per medicine. The natural candidate
--   key for uniqueness is now (Medicine_ID, Batch_No).
-- ============================================================
CREATE TABLE IF NOT EXISTS medicine_inventory (
    ...
    UNIQUE KEY uq_medicine_batch (Medicine_ID, Batch_No),
...
-- ============================================================
-- TABLE: bill  [BCNF FIX — FK updated]
-- CHANGE: Insurance_ID (INT FK) replaced with Policy_Number (VARCHAR FK)
--   to match the updated primary key of the insurance table.
-- ============================================================
...
INSERT INTO bill (Bill_ID, Patient_ID, Bill_Date, Policy_Number, Status) VALUES
(1,  1,  '2025-01-12', 'STAR-2021-001',  'Paid'),
(2,  2,  '2025-01-14', 'HDFC-2022-002',  'Paid'),
(3,  3,  '2025-01-10', 'BAJA-2020-003',  'Paid'),
(4,  4,  '2025-01-15', 'ICICI-2023-004', 'Pending'),
(5,  5,  '2025-01-20', 'BAJA-2022-005',  'Pending'),
(6,  6,  '2025-01-18', 'NIA-2021-006',   'Paid'),
(7,  7,  '2025-01-20', 'UII-2022-007',   'Paid'),
(8,  8,  '2025-01-22', 'ICICI-2021-008', 'Pending'),
(9,  9,  '2025-01-22', 'ORI-2020-009',   'Paid'),
(10, 10, '2025-01-21', 'MAXB-2023-010',  'Paid'),
(11, 11, '2025-01-25', 'NIA-2023-011',   'Pending'),
(12, 12, '2025-01-24', 'REL-2021-012',   'Paid'),
(13, 13, '2025-01-25', 'ABH-2022-013',   'Paid'),
(14, 14, '2025-01-28', 'ORI-2022-014',   'Pending'),
(15, 15, '2025-01-27', 'TATA-2021-015',  'Paid'),
(16, 16, '2025-01-28', 'STAR-2023-016',  'Paid'),
(17, 17, '2025-01-30', 'MAXB-2021-017',  'Pending'),
(18, 18, '2025-01-30', 'HDFC-2020-018',  'Paid');
...
(1,  1,  'Room',     1,  3500.00),  (2,  1,  'Lab Test', 7,   400.00),
(3,  1,  'Lab Test', 16, 2500.00),  (4,  1,  'Medicine', 4,   360.00),
(5,  2,  'Room',     4,  8400.00),  (6,  2,  'Lab Test', 3,   350.00),
(7,  2,  'Medicine', 15,  200.00),  (8,  3,  'Room',     7,  7500.00),
(9,  3,  'Lab Test', 9,  5000.00),  (10, 3,  'Medicine', 5,    75.00),
(11, 4,  'Room',     10, 56000.00), (12, 4,  'Lab Test', 5,   700.00),
(13, 4,  'Medicine', 7,   375.00),  (14, 5,  'Room',     2,  5500.00),
(15, 5,  'Lab Test', 2,   150.00),  (16, 5,  'Medicine', 9,   210.00),
(17, 6,  'Room',     5,  9600.00),  (18, 6,  'Lab Test', 11,  200.00),
(19, 6,  'Medicine', 8,   490.00),  (20, 7,  'Room',     8,  22500.00),
(21, 7,  'Lab Test', 1,   350.00),  (22, 7,  'Medicine', 11, 3000.00),
(23, 8,  'Room',     11, 80000.00), (24, 8,  'Lab Test', 15, 1200.00),
(25, 8,  'Medicine', 13, 1350.00),  (26, 9,  'Room',     3,  4500.00),
(27, 9,  'Lab Test', 10, 4500.00),  (28, 9,  'Medicine', 5,   210.00),
(29, 10, 'Room',     6,  8400.00),  (30, 10, 'Lab Test', 1,   350.00),
(31, 10, 'Medicine', 6,   285.00),  (32, 11, 'Room',     9,  12500.00),
(33, 11, 'Lab Test', 3,   600.00),  (34, 11, 'Medicine', 16, 1900.00),
(35, 12, 'Room',     12, 40000.00), (36, 12, 'Lab Test', 8,   500.00),
(37, 12, 'Medicine', 15,  560.00),  (38, 13, 'Room',     13, 80000.00),
(39, 13, 'Lab Test', 9,  5000.00),  (40, 13, 'Medicine', 7,  1875.00),
(41, 14, 'Room',     15, 40000.00), (42, 14, 'Lab Test', 13,  800.00),
(43, 14, 'Medicine', 2,   560.00),  (44, 15, 'Room',     17, 32000.00),
(45, 15, 'Lab Test', 8,   500.00),  (46, 15, 'Medicine', 8,   245.00),
(47, 16, 'Room',     18, 56000.00), (48, 16, 'Lab Test', 11,  200.00),
(49, 16, 'Medicine', 8,   245.00),  (50, 17, 'Room',     14, 90000.00),
(51, 17, 'Lab Test', 1,   350.00),  (52, 17, 'Medicine', 11, 1500.00),
(53, 18, 'Room',     16, 40000.00), (54, 18, 'Lab Test', 6,   900.00),
...
(5,  3, 5),  (6,  3, 6),  (7,  4, 7),  (8,  4, 8),
(9,  5, 9),  (10, 5, 10), (11, 6, 11), (12, 6, 12),
(13, 7, 13), (14, 7, 14), (15, 1, 15), (16, 2, 16),
(17, 3, 17), (18, 4, 18);

-- ============================================================
-- END OF DUMP
-- BCNF Summary:
--   Tables added    : room_type, doctor_qualification
--   Tables modified : doctor, insurance, medicine_inventory,
--                     room, bill
--   Tables unchanged: department, staff, nurse, shift,
--                     doctor_shift_assignment, nurse_shift_assignment,
--                     patient, appointment, room_assignment,
--                     lab_test, lab_report, medicine,
--                     prescription, prescription_items,
--                     bill_items, payment, nurse_patient_assignment
-- ============================================================
